...
<head>
	...
	<title>User info completion</title>
		                ...
		                <div class="card wizard-card" data-color="green" id="wizard">
		                	<form>
                        		...
                        		<div class="wizard-header">
		                        	...
		                        	<p class="category">Please complete your personal information.</p>
		                    	</div>
		                        ...
		                        <div class="tab-content">
		                            <div class="tab-pane active" id="description">
		                            	<div class="row">
		                                	<div class="col-sm-12">
		                                    	<h5 class="info-text"> Complete your basic information.</h5>
		                            		</div>
                                            
                                            <div class="col-sm-5 col-sm-offset-1">
		                                    	<div class="form-group">
		                                        	<label>First name</label>
		                                        	<input type="text" class="form-control" placeholder="Your given name" name="firstname">
		                                    	</div>
		                                	</div>
                                            ...
                                            <div class="col-sm-5">
		                                    	<div class="form-group">
		                                        	...
		                                        	<input type="text" class="form-control" placeholder="Your family name" name="lastname">
		                                    	</div>
		                                	</div>
                                            ...
                                            <div class="col-sm-5">
		                                    	<div class="form-group">
                                            		...
                                            		<input class="form-control mydatepicker" type='date' name="birth"/>
		                                		</div>
                                            </div>
		                                	...
		                                	<div class="col-sm-5">
		                                    	<div class="form-group">
		                                            <label>City</label>
		                                        	<input type="text" class="form-control" placeholder="Where is your place located?" name="city">
		                                        </div>
		                                	</div>
                                            ...
                                            <div class="col-sm-5">
		                                    	<div class="form-group">
		                                        	...
		                                        	<input type="text" class="form-control" placeholder="What job are you looking for?" name="job">
		                                        </div>
		                                	</div>
                                    ...
                                    <div class="row">
                                        	<h5 class="info-text">Add your required skills.</h5>
		                                    <div class="col-sm-5 col-sm-offset-1">
		                            ...
		                            <div class="tab-pane" id="location">
		                                <h5 class="info-text">Add your optional experiences.</h5>
		                                <div class="row">
		                                    ...
		                                    <div class="col-sm-5">
		                                        <div class="form-group">
		                                            <fieldset>
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Google+ URL">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Ycombinator URL">
