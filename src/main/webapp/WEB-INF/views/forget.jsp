   ...
   <div id="main" class="main-warp">
    <div class="main-content">
        <div class="formDiv">
        	...
        	<h2 class="title text-center">Find password</h2>
            
            <form id="registerForm" role="form" class="form-horizontal " action="forget" method="post">
                    ...
                    <div class="btn-warp">
                        <div class="text-center">
                            <button type="submit" id="btnSubmit" class="btn lgbtn blue btn-block">Reset</button>
