	...
	<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
		<header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
			<div class="mdl-layout__header-row">
				<span class="mdl-layout-title">User basic information</span>
		  ...
		  <div class="mdl-card mdl-cell mdl-cell--12-col">
			<div class="mdl-card__supporting-text mdl-grid mdl-grid--no-spacing">
				<div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
					<h5>User Name</h5>
					${sessionScope.client.getFirstname() } ${sessionScope.client.getLastname() }
				</div>
				<div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
					<h5>Job orientation</h5>
					${sessionScope.client.getJob() }
				</div>
				<div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
					<h5>Address</h5>
					${sessionScope.client.getCity() }, ${sessionScope.client.getCountry() }
				</div>
				<div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
					<h5>Self-introduction</h5>
					${sessionScope.client.getAbout() }
				</div>
                
                <div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
					<h5>Photo</h5>
					<img src="data/user/${sessionScope.client.getEmail() }" />
				</div>
                
			</div>
			<div class="mdl-card__actions">
                <a href="uedit" class="mdl-button">Update</a>
            </div>
          </div>
	   </main>
  	</div>
