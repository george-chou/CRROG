		                ...
		                <div class="card wizard-card" data-color="green" id="wizard">
		                	<form>
                        		...
                        		<div class="wizard-header">
                                	<a href="company">Abort</a>
		                        	<h3 class="wizard-title">Information edit</h3>
		                        	<p class="category">Please edit your company information.</p>
		                    	</div>
		                        ...
		                        <div class="tab-content">
		                            ...
		                            <div class="tab-pane active" id="description">
		                            	<div class="row">
		                                	...
		                                	<div class="col-sm-12">
		                                    	<h5 class="info-text"> Edit required information.</h5>
		                            		</div>
                                            
                                            <div class="col-sm-5 col-sm-offset-1">
		                                    	<div class="form-group">
		                                        	<label>Company name</label>
		                                        	<input type="text" class="form-control" placeholder="Your company name" name="companyname" value="${sessionScope.client.getCompanyname() }">
		                                    	</div>
		                                	</div>
                                            ...
                                            <div class="col-sm-5">
		                                    	<div class="form-group">
		                                        	<label>ABN</label>
		                                        	<input type="text" class="form-control" placeholder="Your company code" name="companycode" value="${sessionScope.client.getCompanycode() }">
		                                    	</div>
		                                	</div>
                                            ...
                                            <div class="col-sm-5 col-sm-offset-1">
		                                    	<div class="form-group">
		                                        	<label>Address</label>
		                                        	<input type="text" class="form-control" placeholder="Your company location" name="location" value="${sessionScope.client.getLocation() }">
		                                    	</div>
		                                	</div>
                                            ...
                                            <div class="col-sm-5">
		                                    	<div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" placeholder="Your company erection date" name="establishdate" value="${sessionScope.client.getEstablishdate() }">
		                                    	</div>
		                                	</div>
		                            ...
		                            <div class="tab-pane" id="type">
                                   		<div class="row">
                                    		<h5 class="info-text">Edit optional information.</h5>
                                            
	                                       	 <div class="col-sm-5 col-sm-offset-1">
		                                    	<div class="form-group">
		                                        	<label>Company index</label>
		                                        	<input type="text" class="form-control" placeholder="Your company homepage" name="homepage" value="${sessionScope.client.getHomepage() }">
		                                    	</div>
		                                	</div>
                                            ...
                                            <div class="col-sm-5">
		                                    	<div class="form-group">
		                                        	...
		                                        	<input type="text" class="form-control" placeholder="Your company phone" name="phone" value="${sessionScope.client.getPhone() }">
		                                    	</div>
		                                	</div>
                                            ...
                                            <div class="col-sm-5 col-sm-offset-1">
		                                    	<div class="form-group">
		                                        	...
		                                        	<input type="text" class="form-control" placeholder="Your company type" name="companytype" value="${sessionScope.client.getCompanytype() }">
		                                    	</div>
		                                	</div>
...
{
	var scale = '${sessionScope.client.getScale() }';
	$('select[name=scale]').find('option[value=' + scale + ']').attr('selected', 'selected');
}
</script>
